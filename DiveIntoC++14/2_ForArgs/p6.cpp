...
{
	// The total number of arguments can be retrieved with
	// the `sizeof...` operator.
...
// Specialization of the implementation function that matches
// the generated index sequences into two `std::size_t` packs.
